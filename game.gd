...
func load_save():
	...
	for game in config.get_sections():
		...
		var donut_reference_view_selection = config.get_value(game, "donut_reference_view_selection")
		...
		donut_ui.load_donut_reference_view_selection(donut_reference_view_selection)
...
func save():
	...
	config.set_value("game", "donut_reference_view_selection", donut_ui.donut_reference_view_selection)
